...
import sakke.dinnerRecipes.web.RecipeController;

@SpringBootTest
public class DinnerRecipesApplicationTests {
	...
	public void responseTypeApplicationJson() throws Exception {
		mockMvc.perform(get("/recipes")).andExpect(content().contentType(MediaType.APPLICATION_JSON))
